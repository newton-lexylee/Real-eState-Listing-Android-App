...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadius = ta.getDimensionPixelSize(R.styleable.SegmentControl_cornerRadius1, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, context.getResources().getDisplayMetrics()));
