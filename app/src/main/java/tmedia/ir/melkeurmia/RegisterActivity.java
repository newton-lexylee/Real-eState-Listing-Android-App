...
import static tmedia.ir.melkeurmia.tools.CONST.GET_CONDITION;
                ...
                .setCallback(new FutureCallback<String>() {
                    ...
                    public void onCompleted(Exception e, String result) {
                        ...
                        if(e == null){
                            ...
                            String ghavanin = root.get("content").getAsString();
                            DroidDialog dialog = new DroidDialog.Builder(context)
                                    .cancelable(true, true)
                ...
                if (!active_code_txt.getText().toString().trim().equals("")) {
                    ...
                    if (enter_code.equals(code)) {
                        ...
                        try {
                            ...
                            progressDialog.show();
                            ApiCallTools.getTK(context, username, (e, response) -> {
