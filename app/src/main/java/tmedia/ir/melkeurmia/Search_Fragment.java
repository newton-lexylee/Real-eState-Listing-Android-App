...
import tmedia.ir.melkeurmia.seach.SearchFilterActivity;
                    ...
                    if(is_search_by_str){
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                                ...
                                search_start_btn.setBackgroundDrawable(getResources().getDrawable(R.drawable.search_icon_clear));
                            }
                        }
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                                ...
                                search_start_btn.setBackgroundDrawable(getResources().getDrawable(R.drawable.search_icon_img));
                            }
                        }
                        listData.clear();
