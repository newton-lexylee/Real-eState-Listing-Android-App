...
public class AllItemAdapter extends RecyclerView.Adapter<AllItemAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        String en_numbers_title = datas.get(position).getTitle();


        viewHolder.order_title.setText(CONST.formatPersianInt(en_numbers_title));
        //viewHolder.order_title.setText(en_numbers_title);
        ...
        //viewHolder.order_type.setText("فوری");
        if(datas.get(position).getIs_lux() == 1){
            viewHolder.order_type.setText("لوکس");
        }else{
            viewHolder.order_type.setVisibility(View.GONE);
        }


        switch (datas.get(position).getGeneral_mode()){
            case "1":
                switch (datas.get(position).getPrice_mode()){
                    case "1":
                        viewHolder.price_bottom_tv.setText(CONST.formatInt(datas.get(position).getPrice()) + " تومان ");
                        break;
                    case "2":
                        viewHolder.price_bottom_tv.setText(datas.get(position).getPrice());
                        break;
                    case "3":
                        viewHolder.price_bottom_tv.setText(datas.get(position).getPrice());
                        break;
                ...
                break;
            case "2":
                viewHolder.price_bottom_tv.setText("درخواستی");
                break;
            case "3":
                viewHolder.price_bottom_tv.setText("رهن " + CONST.formatInt(datas.get(position).getRahan()) + "تومان \nاجاره " + CONST.formatInt(datas.get(position).getEjare()) + " تومان ");
                break;
        }
        ...
        try {
            ...
            viewHolder.order_time.setText(CONST.formatPersianInt(getDifferen(diff)));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView price_bottom_tv;
        ...
        public ViewHolder(View view) {
            ...
            price_bottom_tv = (TextView) view.findViewById(R.id.price_bottom_tv);
