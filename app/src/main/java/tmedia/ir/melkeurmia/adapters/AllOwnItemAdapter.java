...
public class AllOwnItemAdapter extends RecyclerView.Adapter<AllOwnItemAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public AllOwnItemAdapter(Context context, ArrayList<OrderItem> datas) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if(!datas.get(position).isOwn_mode()){
            if(datas.get(position).getType() ==0){
                ...
                viewHolder.order_type.setText("فوری و نردبان");
            }else{
