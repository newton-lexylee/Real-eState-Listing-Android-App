...
import tmedia.ir.melkeurmia.adapters.CategoryMenuPagerAdapter;
...
public class CategorySelector extends DialogFragment implements DialogInterface.OnKeyListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        category_pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
    ...
    public void onResume() {
        ...
        int width = size.x;
        int height = size.y;
        window.setLayout((int) (width * 1), (int) (height * 0.9));
