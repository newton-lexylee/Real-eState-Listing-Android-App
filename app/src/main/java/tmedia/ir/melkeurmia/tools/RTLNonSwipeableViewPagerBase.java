...
import tmedia.ir.melkeurmia.adapters.DelegatingPagerAdapter;
...
public class RTLNonSwipeableViewPagerBase extends ViewPager {
    ...
    public RTLNonSwipeableViewPagerBase(Context context) {
        super(context);
    }

    public RTLNonSwipeableViewPagerBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class ReversingOnPageChangeListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            PagerAdapter adapter = RTLNonSwipeableViewPagerBase.super.getAdapter();
