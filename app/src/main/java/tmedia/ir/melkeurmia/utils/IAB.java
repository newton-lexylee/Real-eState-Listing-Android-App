...
package tmedia.ir.melkeurmia.utils;
...
public class IAB extends Activity {
    ...
    static int[] TANK_RES_IDS = { R.drawable.ic_leaf, R.drawable.ic_leaf, R.drawable.ic_leaf,
            R.drawable.ic_leaf, R.drawable.ic_leaf };
    ...
    public void updateUi() {
       ...
       // findViewById(R.id.infinite_gas_button).setVisibility(mSubscribedToInfiniteGas ? View.GONE : View.VISIBLE);
